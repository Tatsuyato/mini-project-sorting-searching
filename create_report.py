...
for x in ['เพิ่มข้อมูลนักเรียน ตรวจสอบรหัสซ้ำ และตรวจสอบคะแนนให้อยู่ในช่วง 0–100','แสดงรายชื่อนักเรียนพร้อมคะแนนและเกรด','ลบข้อมูลนักเรียนและโหลดข้อมูลตัวอย่าง 12 รายการ','โหมดข้อมูลสังเคราะห์จำลองสำหรับการสาธิต (-data-test / --data-test / --mock-data) โหลดข้อมูลนักเรียน 35 รายการ','เรียงข้อมูลตามคะแนน รหัสนักเรียน หรือชื่อ ทั้งแบบน้อยไปมากและมากไปน้อย','ค้นหาด้วยรหัสหรือคะแนนด้วย Sequential Search และ Binary Search','แสดงขั้นตอน Trace แบบจำกัดจำนวนบรรทัดเพื่อให้เหมาะกับการสาธิต','แสดง Benchmark ของ Sorting ทั้ง 4 วิธี โดยไม่ทำให้โหมด Trace กระทบผล Benchmark']:
    story.append(B(x))
